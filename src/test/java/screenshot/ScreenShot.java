...
public class ScreenShot extends DriverManager{
	public static void takeScreenshotOnSuccess(String ssname) throws IOException {
		...
		File destination = new File
				("C:\\Users\\glend\\eclipse-workspace\\CucumberFrameworkTesting5\\OnSuccessScreenshot\\"+FrameworkHook.foldername+"\\"+dateTime1+"_"+ssname+".jpg");
	...
	public static void takeScreenshotOnFailure() throws IOException {
		...
		File src=((TakesScreenshot)driver).getScreenshotAs(OutputType.FILE);
		File destination = new File
				("C:\\Users\\glend\\eclipse-workspace\\CucumberFrameworkTesting5\\OnFailureScreenshot\\"+FrameworkHook.foldername+"\\"+dateTime1+"_"+"Failure"+".jpg");
		FileUtils.copyFile(src,destination);
		System.out.println("Screenshot taken");
